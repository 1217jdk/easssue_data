...
with DAG(
        ...
        start_date=datetime(2023, 2, 9, 0, 30, 0),
        catchup=False,
        tags=[f'{today}'],
    ...
    mongodb_rec_kwd = BashOperator(
        task_id='mongodb_rec_kwd',
        depends_on_past=False,
        bash_command='python3 /root/Data/py/mongodb_rec_kwd.py',
    )

    rel_kwd_find_over10_under10 >> rel_kwd_over_10 >> rel_kwd_under_10 >> db_rel_kwd >> mongodb_rec_kwd
